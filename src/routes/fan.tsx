  ...
  head: () => ({
    meta: [
      { title: "Fan Experience Center · WorldCupIQ AI" },
      {
        name: "description",
        content:
          "Fan wayfinding, food discovery, multilingual guidance and personalized experience recommendations.",
      },
    ],
  }),
  component: FanPage,
...
function FanPage() {
  return (
    <AppShell
      title="Fan Experience Center"
      subtitle="Wayfinding, food, multilingual guidance and personalized moments"
    >
      <div className="grid gap-3 md:grid-cols-4">
        <KpiCard
          label="Fans assisted today"
          value="18,204"
          delta="+9% vs baseline"
          tone="good"
        ...
        <div className="glass rounded-2xl p-5">
          ...
          <ul className="space-y-2 text-sm">
            <li className="rounded-lg border border-primary/25 bg-primary/8 p-3">
              Get me to my seat, step-free.
            </li>
            <li className="rounded-lg border border-border/60 bg-card/40 p-3">
              Best exit strategy for this match.
            </li>
            <li className="rounded-lg border border-border/60 bg-card/40 p-3">
              Translate this sign into Arabic.
            </li>
            <li className="rounded-lg border border-border/60 bg-card/40 p-3">
