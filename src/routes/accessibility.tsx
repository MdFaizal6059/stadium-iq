  ...
  head: () => ({
    meta: [
      { title: "Accessibility Center · WorldCupIQ AI" },
      {
        name: "description",
        content:
          "Step-free routing, assisted services and accessibility resources for FIFA World Cup 2026 venues.",
      },
    ],
  }),
...
const services = [
  { icon: Accessibility, label: "Wheelchair loans", value: "42 available", desk: "N-2, S-1, E-3" },
  {
    ...
    value: "12 kits deployed",
    desk: "Info desks all zones",
  },
  {
    icon: Eye,
    label: "Visual guides",
    value: "24 volunteers on shift",
    desk: "Meet at Gate A / D",
  },
  {
    icon: HeartHandshake,
    label: "Companion support",
    value: "On-request",
    desk: "Call center · 24/7",
  },
];
...
function AccessibilityPage() {
  return (
    <AppShell
      ...
      subtitle="Step-free routes, assisted services and inclusive fan support"
    >
      <div className="grid gap-3 md:grid-cols-4">
        ...
        <KpiCard
          ...
          value="317"
          delta="avg. 3m 12s response"
          tone="good"
        />
        <KpiCard
          label="Escalations open"
          value="1"
          hint="wheelchair lift E-2 maintenance"
          tone="warn"
        />
      </div>
            ...
            {routes.map((r, i) => (
              <li key={i} className="rounded-xl border border-border/60 bg-card/40 p-3">
                ...
                <div className="text-xs text-muted-foreground">
                  Steps {r.steps} · ETA {r.eta} · surface {r.surface}
                </div>
              </li>
            ))}
          </ul>
